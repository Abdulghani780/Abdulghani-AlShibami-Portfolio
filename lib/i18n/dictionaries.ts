...
export const dictionaries: Record<Locale, Dictionary> = {
  en: {
    ...
    hero: {
      ...
      profilePlaceholder: "Abdulghani Al-Shibami",
      profileVerified: "Verified Computer Systems & AI Solutions Engineer",
      coordinates: "RATIO: 4:5 // VERIFIED PROFILE ASSET",
    },
    telemetry: {
      heading: "Engineering Portfolio Telemetry & Metrics",
      subheading: "Verified quantitative metrics across authentic systems, platforms, and localization parity.",
      throughputLabel: "Verified Systems",
      throughputValue: "5 Projects",
      throughputDesc: "Authentic desktop and web applications",
      latencyLabel: "Core Platforms",
      latencyValue: "2 Platforms",
      latencyDesc: "Windows Desktop (.NET) & Modern Web",
      availabilityLabel: "Technical Domains",
      availabilityValue: "3 Domains",
      availabilityDesc: "ITIL Infrastructure, Algorithms, E-Commerce",
      verificationLabel: "Bilingual Parity",
      verificationValue: "100% LTR/RTL",
      verificationDesc: "Full native English and Arabic parity",
    },
    featured: {
  ...
  ar: {
    ...
    hero: {
      ...
      profilePlaceholder: "عبدالغني الشبامي",
      profileVerified: "مهندس نظم حاسوبية وحلول ذكاء اصطناعي معتمد",
      coordinates: "النسبة: 4:5 // أصل معتمد للملف الشخصي",
    },
    telemetry: {
      heading: "القياسات والإحصاءات الهندسية المعتمدة",
      subheading: "مؤشرات كمية حقيقية وموثقة عبر الأنظمة البرمجية والمنصات وتطابق التعريب.",
      throughputLabel: "الأنظمة المعتمدة",
      throughputValue: "٥ مشاريع",
      throughputDesc: "تطبيقات سطح مكتب ومنصات ويب حقيقية",
      latencyLabel: "المنصات الأساسية",
      latencyValue: "منصتان",
      latencyDesc: "تطبيقات ويندوز (.NET) والويب الحديث",
      availabilityLabel: "المجالات التقنية",
      availabilityValue: "٣ مجالات",
      availabilityDesc: "بنية ITIL التحتية، الخوارزميات، والتجارة",
      verificationLabel: "تطابق اللغات",
      verificationValue: "١٠٠٪ RTL/LTR",
      verificationDesc: "توافق كامل ثنائي اللغة للإنجليزية والعربية",
    },
    featured: {
