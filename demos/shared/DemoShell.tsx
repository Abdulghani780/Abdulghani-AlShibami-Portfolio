...
export function DemoShell({
  ...
  return (
    ...
    >
      ...
      <div className="w-full rounded-2xl border border-glass-border bg-obsidian-card shadow-glass overflow-hidden flex flex-col transition-colors duration-200">
        ...
        <div className="bg-surface-secondary px-4 py-2.5 border-b border-border/70 flex items-center justify-between select-none">
          <div className="flex items-center gap-2">
            ...
            <span className="text-[11px] font-mono text-content-muted ml-2 hidden sm:inline">
              // {projectSlug} [INTERACTIVE_SIMULATION]
            </span>
          </div>

          <div className="text-xs font-mono font-medium text-content-secondary text-center truncate px-2">
            {title}
          </div>

          <div className="text-[10px] font-mono font-semibold text-gold bg-gold/10 px-2.5 py-0.5 rounded border border-gold/30">
            {isRtl ? "محاكاة تفاعلية" : "INTERACTIVE SIMULATION"}
          </div>
        </div>
