  ...
  return (
    <section id="credentials" className="w-full space-y-8 font-mono" dir={isAr ? "rtl" : "ltr"}>
      ...
      <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4 border-b border-slate-800/80 pb-4">
        <div>
          <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-indigo-500/10 border border-indigo-500/25 text-[10px] tracking-[0.18em] text-cyan-400 uppercase mb-2">
        ...
        <div className="flex items-center gap-2.5 shrink-0 flex-wrap sm:flex-nowrap">
          <a
            ...
            className="px-4 py-2 rounded-lg bg-slate-900 border border-slate-700/80 hover:border-slate-500 text-slate-200 hover:text-white text-xs font-semibold flex items-center gap-2 transition-all cursor-pointer shadow-sm active:scale-95"
          >
      ...
      <div className="rounded-2xl border border-indigo-500/30 bg-gradient-to-br from-[#0F172A]/90 via-[#0B1120]/95 to-[#070B14] p-5 sm:p-6 shadow-xl space-y-4">
